...
extension ViewController: UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.DocCB.backgroundColor=UIColor(hex:self.serviceColor[indexPath.row],alpha:CGFloat(NSNumber(value: indexPath.row==self.selectedIndex)));
        
        return cell;
    }
}
//--DocCollecrtionViewのdelegate
